...
export const FloatingActions = () => {
  ...
  return (
    <div className="floating-actions-shell">
        ...
        <div className="assistant-panel mb-3">
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <p className="mt-2 text-sm text-[#d0d0d0]">Respuestas rapidas para las preguntas que mas llegan.</p>
            </div>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="whatsapp-button mt-4 block w-full text-center focus:outline-none focus:ring-2 focus:ring-[#00c56b]/60"
          >
            Hablar por WhatsApp
          </a>
        </div>
      ...
      <a href={whatsappLink} target="_blank" rel="noreferrer" className="whatsapp-float" aria-label="Hablar por WhatsApp">
